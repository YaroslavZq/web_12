...
class Auth:
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param data: dict: Pass the data that you want to encode into the jwt
    ...
    async def create_refresh_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass in the user's id, email and username
    ...
    async def decode_refresh_token(self, refresh_token: str):
        ...
        :return: The email of the user that is stored in the payload of the refresh token
        :doc-author: Trelent
        """
        try:
